      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          >
            ...
            <p>
              Every single dish we serve is made from 100% premium ingredients, never frozen, and prepared fresh every single morning. We hand-stretch our pizza dough and double-smash our gourmet beef patties, achieving those gorgeous crispy, lacey edges that lock in the flavor.
            </p>
